...
function updateUserMarker(user) {
    ...
    if (userMarkers.has(userKey)) {
        ...
        smoothMove(marker, "marker", prevPos, newPosition, 800, "easeInOutCubic");
        smoothMove(circle, "circle", prevPos, newPosition, 800, "easeInOutCubic");
...
async function initMap() {
    ...
    const floorPlanOverlay = new google.maps.GroundOverlay(`${currentUrl}/assets/img/map.png`, floorPlanBounds, {opacity: 0.3});
